...
export const mapWikipediaFieldToKey: Record<WikipediaPlayerDetailsFields, PlayerDetailsKeys> = {
  ...
  [WikipediaPlayerDetailsFields.PLACE_OF_BIRTH]: PlayerDetailsKeys.PLACE_OF_BIRTH,
